...
:::{.fragment}
:::{.callout}
[Relative risk (RR):]{.green} the ratio of the incidence of the outcome of interest in a risk group to the incidence of the outcome in a comparison group.
...
[For uncommon outcomes, the OR approximates the RR for an association.]{.aside}
:::
:::
:::
:::
...
![](figures/epidemiology/epidemiology_design.jpg){width="40%"}
