...
here::i_am("conbio/syllabus.qmd")
source(here::here("_common.R"))
course_short <- str_extract(params$course, "\\w+(?=_)")

learning_outcomes(params$course) %>% gtsave(here(paste0(course_short, "/figures/syllabus/learning_outcomes.png")))
grade_breakdown(params$course)   %>% gtsave(here(paste0(course_short, "/figures/syllabus/grade_breakdown.png")))
resources(params$course)         %>% gtsave(here(paste0(course_short, "/figures/syllabus/resources.png")))
```
...
#| title: "Graded Project"
  ...
  if (format == "Guided Case Conversations") {
    points   <- sum(as.numeric(assessment[[params$course]]$assignments$case_convo1), as.numeric(assessment[[params$course]]$assignments$case_convo2))
