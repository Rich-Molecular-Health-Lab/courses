semesters <- list(
  ...
  "26f" = list(
    start_class  = ymd("2026-08-24"),
    end_class    = ymd("2026-12-11"),
    start_finals = ymd("2026-12-14"),
    end_finals   = ymd("2026-12-18"),
    holidays = list(
      ymd("2025-09-07"),
      ymd("2025-10-19"),
      ymd("2025-10-20"),
...
semester_weeks <- function(semester = "26f") {
...
current_week <- function(semester = "26f") {
